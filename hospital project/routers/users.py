...
def register_user(user: UserCreate):
    ...
    try:
        ...
        user_record = {
            ...
            "is_active": True,
            # Pharma fields
            "company_name": user.company_name if role_str == "pharma" else None,
            "product1": user.product1 if role_str == "pharma" else None,
            "product2": user.product2 if role_str == "pharma" else None,
            "product3": user.product3 if role_str == "pharma" else None,
            "product4": user.product4 if role_str == "pharma" else None,
            # Doctor fields
            "degree": user.degree if role_str == "doctor" else None,
            "institute_name": user.institute_name if role_str == "doctor" else None,
            "experience1": user.experience1 if role_str == "doctor" else None,
            "experience2": user.experience2 if role_str == "doctor" else None,
            "experience3": user.experience3 if role_str == "doctor" else None,
            "experience4": user.experience4 if role_str == "doctor" else None,
        }
...
@router.get("/doctors")
def get_all_doctors():
    """Get list of all registered doctors - using Supabase"""
    supabase = get_supabase()
    if not supabase:
        return []
